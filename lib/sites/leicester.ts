...
// Ported from html/asbestosabatementleicester.co.uk.html. All copy below
...
const TEAM_IMAGE =
  "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/ce4c02b5a_images6.jpg";
const NEARME_IMAGE =
  "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/4fbc09fec_download4.jpg";

// Leicester's source assigns a genuinely distinct hero image to nearly
// every service page (unlike some cities which reuse a handful of stock
// photos), so each service below gets its own image constant.
const SURVEY_IMAGE =
...
const CONTRACTORS_IMAGE =
  "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/540eb0997_RSshutterstock_466830251.jpg";
...
const config: SiteConfig = {
  businessName: "Leicester Asbestos Removal",
  logoLetter: "L",
  city: "Leicester",
  ...
  hero: {
    tag: "Serving Leicestershire",
    titleBefore: "Leicester's Trusted",
    titleHighlight: "Asbestos Removal",
    titleAfter: "Specialists",
    subtitle:
      "Safe, certified, and competitively priced asbestos removal, survey, testing, and disposal services across Leicester and Leicestershire. HSE-licensed operatives, UKAS-accredited laboratory analysis, and a commitment to protecting your property and your health.",
    image: HERO_IMAGE,
    trustPills: [
      "✓ HSE Licensed",
      "✓ UKAS Accredited",
  ...
  services: [
    {
      ...
      shortDescription:
        "UKAS-accredited management and R&D surveys across Leicester and Leicestershire.",
      heroImage: SURVEY_IMAGE,
      pageSubtitle:
        "UKAS-accredited management and R&D surveys across Leicester and Leicestershire. Detailed reports, expert recommendations, fast booking.",
      figureCaption: "Asbestos Surveys — Leicester, Leicestershire",
      content: [
        {
          type: "h2",
          text: "Professional Asbestos Surveys in Leicester, Leicestershire",
        },
        {
          type: "p",
          text: "An asbestos survey is the critical first step in managing asbestos safely. Under the Control of Asbestos Regulations 2012, all non-domestic properties in Leicester must have an up-to-date asbestos register. Our UKAS-accredited surveyors provide thorough, compliant surveys for all property types across Leicestershire.",
        },
        { type: "h2", text: "Types of Asbestos Survey Available in Leicester" },
        { type: "h3", text: "Management Survey" },
        {
          type: "p",
          text: "The standard survey for occupied premises. Our surveyor systematically inspects and samples suspect materials throughout your Leicester property, providing a detailed report with risk ratings, photographs, and floor plans. Surveys conducted to HSG264.",
        },
        { type: "h3", text: "Refurbishment & Demolition Survey" },
        {
          type: "p",
          text: "Legally required before any refurbishment or demolition work in Leicester. A fully intrusive survey identifying all ACMs, including those in inaccessible areas. Required before submitting notifications to the HSE.",
        },
        { type: "h3", text: "Re-Inspection Survey" },
        {
          type: "p",
          text: "Periodic re-inspections of your existing asbestos register ensure it remains accurate and up-to-date for your Leicester property. Recommended annually or following any disturbance event.",
        },
        { type: "h2", text: "What Your Leicester Survey Report Includes" },
        {
          type: "ul",
          items: [
        ...
        },
        {
          type: "callout",
          tone: "info",
          text: "📋 Management surveys from £250. R&D surveys priced on application for your Leicester property.",
        },
        { type: "h2", text: "Duty to Manage Asbestos in Leicester" },
        {
          type: "p",
          text: "Regulation 4 of the Control of Asbestos Regulations 2012 places a legal duty on anyone responsible for a non-domestic property in Leicester to manage asbestos. Failure to comply can result in prosecution by the HSE. Our survey service helps you fulfil this duty comprehensively.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "UKAS-accredited asbestos testing, bulk sampling, and air monitoring across Leicester and Leicestershire. Fast results, expert analysis from £60.",
      figureCaption: "Asbestos Testing — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Professional Asbestos Testing in Leicester, Leicestershire" },
        {
          type: "p",
          text: "If you suspect asbestos in your Leicester property, the only reliable way to confirm its presence and identify fibre types is through laboratory analysis. Our UKAS-accredited asbestos testing service provides fast, accurate results for residential and commercial clients across Leicestershire.",
        },
        { type: "h2", text: "Asbestos Testing Services in Leicester" },
        { type: "h3", text: "Bulk Sampling & Analysis" },
        {
          type: "p",
          text: "Our operatives take physical samples of suspect materials from your Leicester property. Samples are analysed using Polarised Light Microscopy (PLM) in our UKAS-accredited laboratory, identifying the presence and type of asbestos fibres with complete accuracy.",
        },
        { type: "h3", text: "Air Monitoring" },
        {
          type: "p",
          text: "During asbestos removal works in Leicester, continuous air monitoring ensures fibre concentrations remain below the legal Control Limit of 0.1 f/cm³. Monitoring is conducted by qualified BOHS P402 analysts.",
        },
        { type: "h3", text: "Four-Stage Clearance Testing" },
        {
          type: "p",
          text: "Following licensed asbestos removal, four-stage clearance testing (visual inspection, PCM air testing, reoccupation certificate) confirms your Leicester property is safe before reoccupation.",
        },
        { type: "h2", text: "When Should You Arrange Asbestos Testing in Leicester?" },
        {
          type: "ul",
          items: [
            ...
            "You are purchasing a property in Leicester or Leicestershire",
    ...
    },
    {
      ...
      shortDescription:
        "HSE-licensed asbestos removal contractors serving Leicester and Leicestershire. Fully insured, UKAS accredited.",
      heroImage: CONTRACTORS_IMAGE,
      pageSubtitle:
        "HSE-licensed asbestos removal contractors serving Leicester and Leicestershire. Fully insured, UKAS accredited, and British Standards compliant. Free site visits.",
      figureCaption: "Licensed Asbestos Removal — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "HSE-Licensed Asbestos Contractors in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Selecting the right asbestos removal contractor in Leicester is one of the most important decisions you can make when dealing with asbestos in your property. Using an unlicensed contractor is illegal for many types of asbestos work, and exposes you and your family or workforce to serious health risks.",
        },
        {
          type: "p",
          text: "Leicester Asbestos Removal holds a full HSE licence for licensed asbestos removal work. We specialise in asbestos removal, abatement, encapsulation, testing, and clean-up for residential, commercial, and industrial clients across Leicestershire.",
        },
        { type: "h2", text: "What to Look for in a Leicester Asbestos Contractor" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Our Experience Across Leicestershire" },
        {
          type: "p",
          text: "Our team has completed hundreds of asbestos removal projects across Leicester and Leicestershire — from Victorian-era residential properties to modern commercial and industrial facilities. We have worked for private homeowners, local authorities, NHS trusts, schools, housing associations, and major developers.",
        },
        { type: "h2", text: "Emergency Contractor Services in Leicester" },
        {
          type: "p",
          text: "For asbestos emergencies across Leicester and Leicestershire, our 24/7 response team can mobilise within hours. We assess the situation, make the area safe, and begin remediation works — all fully documented and compliant.",
        },
      ],
    },
    {
      ...
      content: [
        ...
        { type: "h2", text: "Our Non-Licensed Removal Process in Leicester" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Non-Licensed Removal Costs in Leicester" },
        {
          type: "p",
          text: "Non-licensed asbestos removal is significantly more affordable than licensed work. Typical costs in Leicester range from £300 for small domestic jobs to £2,500+ for larger commercial or industrial projects. All quotations are fixed-price. Contact us for a free site visit and itemised quote.",
        },
        {
          type: "callout",
          tone: "warning",
    ...
    },
    {
      ...
      shortDescription:
        "Specialist removal of asbestos cement garage roofs and full garage dismantle & demolition across Leicestershire.",
      heroImage: GARAGE_ROOF_IMAGE,
      pageSubtitle:
        "Safe, professional removal and full dismantle of asbestos cement garage roofs across Leicester and Leicestershire. Fast, affordable, fully licensed. Free quotes available.",
      figureCaption: "Garage Roof Removal — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Asbestos Garage Roof Removal & Dismantle in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Asbestos cement corrugated roofing is one of the most common asbestos-containing materials found in Leicester properties. Many garages, sheds, and outbuildings across Leicestershire were constructed using asbestos cement sheets before the year 2000. Whether you need the roof sheets removed and replaced, or the entire garage structure dismantled and cleared, our licensed team handles it all as a single, fully managed project.",
        },
        { type: "h2", text: "Signs Your Leicester Garage Roof Contains Asbestos" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Asbestos Garage Roof Removal in Leicester" },
        {
          type: "p",
        ...
        { type: "h2", text: "Full Garage Dismantle & Demolition in Leicester" },
        {
          type: "p",
        ...
        },
        {
          type: "callout",
          tone: "info",
          text: "🏗️ Our combined asbestos removal and garage dismantle package offers significant savings versus using separate contractors. One survey, one team, one fixed price — ask us about our combined packages for Leicester and Leicestershire properties.",
        },
        { type: "h2", text: "What Types of Garage We Dismantle in Leicester" },
        {
          type: "ul",
          items: [
    ...
    },
    {
      ...
      pageSubtitle:
        "Complete re-roofing services for garages, factories, commercial premises, and agricultural buildings following asbestos cement roof removal across Leicester and Leicestershire.",
      figureCaption: "Re-Roofing Services — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Re-Roofing After Asbestos Removal in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Once asbestos cement roofing has been safely removed from your garage, factory, commercial unit, agricultural building, or residential outbuilding in Leicester, the structure requires a new, weatherproof roof. Rather than leaving you to find a separate roofing contractor, our team provides a complete re-roofing service following all types of asbestos roof removal — available for garages, industrial units, commercial premises, farm buildings, and residential extensions across Leicestershire.",
        },
        { type: "h2", text: "Re-Roofing Options After Asbestos Removal in Leicester" },
        { type: "h3", text: "Garage & Domestic Outbuilding Re-Roofing" },
        {
          type: "p",
          text: "After asbestos cement corrugated roofing is removed from garages, car ports, garden rooms, and domestic outbuildings in Leicester, we offer a range of replacement roofing systems:",
        },
        {
          type: "ul",
          items: [
        ...
        { type: "h3", text: "Commercial & Industrial Re-Roofing in Leicester" },
        {
          type: "p",
          text: "Industrial units, factory buildings, warehouses, and commercial premises in Leicester and Leicestershire often have large areas of asbestos cement roofing requiring replacement. We provide:",
        },
        {
          type: "ul",
          items: [
        ...
        { type: "h3", text: "Agricultural Building Re-Roofing in Leicester & Leicestershire" },
        {
          type: "p",
          text: "Farm buildings, storage barns, machinery sheds, and livestock buildings across Leicestershire frequently have large spans of asbestos cement roofing that require replacement. We work with farmers and rural estate owners to provide:",
        },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Combined Removal & Re-Roofing Package in Leicester" },
        {
          type: "p",
          text: "Our most popular service for Leicester and Leicestershire clients is our combined asbestos removal and re-roofing package. We survey, remove the asbestos roofing, carry out all waste disposal with full documentation, and then install the new roofing system — all in one project, with a single fixed price and a single point of responsibility. This eliminates the risk of programme delays between removal and re-roofing and typically provides significant cost savings versus using two separate contractors.",
        },
        {
          type: "callout",
          tone: "info",
          text: "🏗️ Ask about our combined asbestos roof removal & re-roofing package for your Leicester property. We'll survey, remove, dispose, and re-roof — all in one visit where possible, with a single fixed-price quotation.",
        },
        { type: "h2", text: "Re-Roofing Costs in Leicester" },
        {
          type: "p",
          text: "Re-roofing costs after asbestos removal depend on the area, roof pitch, material chosen, and access requirements. Typical costs in Leicester for a single garage re-roof start from £600. Industrial and agricultural re-roofing is priced per m². Contact us for a free site visit and fixed-price combined quotation.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Complete reboard and plastering services following asbestos artex, ceiling board, and wall board removal across Leicester and Leicestershire. Seamless finish guaranteed.",
      figureCaption: "Reboard & Plastering — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Reboard & Plastering After Asbestos Removal in Leicester, Leicestershire" },
        {
          type: "p",
        ...
        { type: "h2", text: "Our Reboard & Plastering Service in Leicester" },
        {
          type: "ul",
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "p",
          text: "For licensed asbestos removal in Leicester carried out within a full containment enclosure, we carry out systematic leak testing of the enclosure perimeter before removal commences, ensuring no fibres escape to the surrounding environment.",
        },
        { type: "h3", text: "Four-Stage Clearance Testing" },
        {
          type: "p",
          text: "Four-stage clearance is a mandatory process following all licensed asbestos removal in Leicester. The four stages are:",
        },
        {
          type: "ul",
          items: [
        ...
        {
          type: "p",
          text: "Reassurance air sampling is available for Leicester properties where asbestos has been disturbed accidentally — for example during renovation works — and where the client needs independent confirmation that the area is safe. Results are typically available within 24–48 hours.",
        },
        {
          type: "callout",
          tone: "info",
          text: "🔬 All air testing in Leicester is carried out by BOHS P402-qualified analysts. Laboratory analysis is UKAS-accredited to ISO 17025. Results include a full written report and reoccupation certificate where applicable.",
        },
        { type: "h2", text: "Air Testing Costs in Leicester" },
        {
          type: "p",
          text: "Air testing costs depend on the type of sampling required and the number of samples taken. Four-stage clearance testing for a standard single-room licensed removal in Leicester typically costs £350–£600. Background sampling and personal air monitoring are priced on application. Contact us for a fixed-price quotation.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Professional soil remediation and contaminated land testing across Leicester and Leicestershire. Asbestos in soil, contaminated ground, and brownfield site clearance specialists.",
      figureCaption: "Soil Remediation & Testing — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Soil Remediation & Testing in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Asbestos does not only exist inside buildings — it is commonly found in the ground on brownfield sites, former industrial land, and residential gardens across Leicester and Leicestershire. Asbestos-containing materials dumped as hardcore, fly-tipped on land, or left behind from demolished buildings can contaminate soil to significant depths. Our team provides comprehensive soil testing and remediation services for developers, landowners, local authorities, and homeowners across Leicestershire.",
        },
        { type: "h2", text: "How Does Asbestos Get Into Soil in Leicester?" },
        {
          type: "ul",
          items: [
            "Demolition hardcore: crushed asbestos cement used as sub-base or hardcore fill under drives, paths, and floors — extremely common in Leicester properties built or extended before 2000",
            "Fly-tipping: illegally dumped asbestos waste on agricultural and brownfield land across Leicestershire",
            ...
            "Industrial sites: former factories, yards, and industrial premises in Leicester where asbestos was routinely stored, processed, or discarded",
          ],
        },
        { type: "h2", text: "Soil Testing for Asbestos in Leicester" },
        {
          type: "p",
        ...
        },
        {
          ...
          items: [
            ...
            "Trial pit and borehole investigation — physical ground investigation to characterise the depth and extent of contamination across the Leicester site",
            ...
            "Contamination report — a formal site investigation report presenting findings, risk assessment, and remediation recommendations, suitable for submission to Leicestershire Council planning teams",
          ],
        },
        { type: "h2", text: "Soil Remediation Services in Leicester" },
        ...
        { type: "h2", text: "Get a Soil Testing & Remediation Quote for Your Leicester Site" },
        {
          type: "p",
          text: "Contact our Leicester team today for a free initial consultation and fixed-price quotation for soil investigation and remediation across Leicestershire.",
        },
      ],
    },
    {
      ...
      shortDescription:
        "Pre-demolition surveys, soft strip, structural demolition, and site clearance across Leicestershire.",
      heroImage: DEMOLITION_IMAGE,
      pageSubtitle:
        "Safe, licensed demolition services across Leicester and Leicestershire. Pre-demolition asbestos surveys, structural demolition, soft strip, and site clearance. HSE notified, fully insured.",
      figureCaption: "Demolition Services — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Demolition Services in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Our Leicester team provides professional demolition services for residential, commercial, and industrial structures across Leicestershire — from single garage demolition and internal soft strip to full structural demolition of large commercial and industrial buildings. Crucially, all demolition work is preceded by a thorough refurbishment and demolition (R&D) asbestos survey and the removal of all identified ACMs before any structural works commence, ensuring full HSE compliance and the safety of all workers and neighbouring occupiers.",
        },
        { type: "h2", text: "Our Demolition Services in Leicester" },
        { type: "h3", text: "Pre-Demolition Asbestos Survey" },
        {
          type: "p",
          text: "The Control of Asbestos Regulations 2012 requires a refurbishment and demolition (R&D) survey to be completed before any demolition work in Leicester. This is a fully intrusive survey that identifies all asbestos-containing materials — including those in inaccessible locations — and provides a schedule for their removal before demolition proceeds. Our UKAS-accredited surveyors carry out R&D surveys across all Leicestershire property types.",
        },
        ...
        {
          type: "p",
          text: "Our Leicester structural demolition team provides safe, controlled demolition of residential and commercial structures including:",
        },
        {
          type: "ul",
          items: [
        ...
        {
          type: "p",
          text: "Following demolition, our team provides comprehensive site clearance — breaking out foundations, removing all demolition arisings, grading the site to formation level, and leaving the ground ready for your next development phase. Combined demolition and muck-away packages are available across Leicestershire.",
        },
        {
          type: "callout",
          tone: "info",
          text: "🛡️ All demolition work carried out by our Leicester team is HSE notified where required, fully insured, and conducted in accordance with BS 6187:2011 Code of Practice for Full and Partial Demolition. Method statements and risk assessments are provided for every project.",
        },
        { type: "h2", text: "Get a Demolition Quote in Leicester" },
        {
          type: "p",
          text: "Contact our Leicester team for a free site survey and fixed-price demolition quotation across Leicestershire. We handle everything from pre-demolition survey to site clearance — one contractor, one price.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Licensed muck away and waste haulage across Leicester and Leicestershire. Soil, demolition arisings, asbestos-contaminated material, and construction waste removed and disposed of compliantly.",
      figureCaption: "Muck Away — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Muck Away Services in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Our Leicester muck away service provides fast, cost-effective removal and disposal of soil, demolition arisings, construction waste, and excavated material from sites across Leicestershire. As a licensed waste carrier with our own haulage fleet, we provide competitive muck away services for developers, building contractors, groundworkers, homeowners, and local authorities across Leicester and the surrounding area.",
        },
        { type: "h2", text: "What We Remove" },
        {
          type: "ul",
          items: [
            "Clean excavated soil and subsoil — from construction excavations, garden re-levels, and drainage works across Leicestershire",
            "Demolition arisings — brick, concrete, timber, and mixed demolition waste from structural demolition projects in Leicester",
        ...
        { type: "h2", text: "Our Muck Away Process in Leicester" },
        {
          type: "ul",
          items: [
            "Waste classification: before any material is removed from your Leicester site, we classify the waste in accordance with the Waste Framework Directive and confirm the appropriate disposal route — essential for both compliance and cost management",
            "Loading and haulage: our fleet of tipper lorries and grab vehicles provides efficient, rapid loading and haulage from sites across Leicestershire",
        ...
        { type: "h2", text: "Asbestos-Contaminated Muck Away in Leicester" },
        {
          type: "p",
          text: "Asbestos-contaminated soil and demolition waste requires specialist handling and disposal. As a licensed hazardous waste carrier with full asbestos removal credentials, we are uniquely placed to handle mixed asbestos and soil remediation projects — removing asbestos-contaminated material from your Leicester site, completing all hazardous waste consignment documentation, and disposing of the material at a permitted site. This single-contractor approach significantly reduces project complexity and cost.",
        },
        {
          type: "callout",
          tone: "warning",
          text: "⚠️ It is a criminal offence to fly-tip soil or construction waste — including asbestos-contaminated material. Ensure any contractor removing waste from your Leicester site provides a valid waste carrier licence number and written duty of care documentation. We provide these as standard on every project.",
        },
        { type: "h2", text: "Muck Away Costs in Leicester" },
        {
          type: "p",
          text: "Muck away costs in Leicester depend on the type and volume of material, access to the site, and the applicable disposal route. Clean inert soil removal starts from £150 per load. Asbestos-contaminated material is priced on application following site assessment. Contact us for a competitive, fixed-price quotation across Leicestershire.",
        },
        { type: "h2", text: "Get a Muck Away Quote for Your Leicester Site" },
        {
          type: "p",
          text: "Call our Leicester team today for rapid, cost-effective muck away services across Leicestershire. Same-day and next-day loading available on most projects.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Licensed asbestos waste disposal in Leicester, Leicestershire. Full consignment note documentation. Certified, safe, and fully compliant with UK waste regulations.",
      figureCaption: "Asbestos Disposal — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Licensed Asbestos Disposal in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Asbestos waste is classified as hazardous waste under the Hazardous Waste Regulations 2005. In Leicester and across Leicestershire, all asbestos waste must be handled, transported, and disposed of in strict accordance with the law. Leicester Asbestos Removal holds a valid waste carrier's licence and ensures full legal compliance on every project.",
        },
        { type: "h2", text: "Legal Requirements for Asbestos Disposal in Leicester" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Our Leicester Asbestos Disposal Process" },
        {
          type: "p",
        ...
        { type: "h2", text: "Disposal Costs in Leicester" },
        {
          type: "p",
          text: "Disposal costs depend on the type and volume of asbestos waste. All disposal costs are included in our removal quotations — there are no surprise charges. Contact us for a specific disposal quote for your Leicester project.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Transparent pricing for asbestos removal, surveys, testing, and encapsulation across Leicester and Leicestershire. No hidden fees.",
      figureCaption: "Asbestos Removal Costs — Leicester, Leicestershire",
      content: [
        { type: "h2", text: "Asbestos Removal Costs in Leicester, Leicestershire" },
        {
          type: "p",
          text: "Understanding asbestos removal costs in Leicester is essential to planning your project. At Leicester Asbestos Removal, we provide fixed-price, fully itemised quotations — no surprises, no hidden charges.",
        },
        {
          type: "priceGrid",
          items: [
        ...
        { type: "h2", text: "What Affects Asbestos Removal Costs in Leicester?" },
        {
          type: "ul",
          items: [
            ...
            "Location: properties in central Leicester versus outlying Leicestershire areas may have different logistics costs.",
        ...
        { type: "h2", text: "Asbestos Encapsulation Costs in Leicester" },
        {
          type: "p",
        ...
        { type: "h2", text: "Get an Accurate Quote for Your Leicester Property" },
        {
          type: "p",
          text: "Contact our team today for a free site visit and fixed-price quotation for your Leicester or Leicestershire property.",
        },
      ],
    },
  ],
  ...
  localInfo: {
    tag: "Local Expertise — Leicester",
    title: "Asbestos in Leicester's Victorian Terraces and Post-War Developments",
    paragraphs: [
      "Leicester — a diverse and rapidly growing East Midlands city — has an extensive property stock spanning Victorian terraces, interwar semis, post-war estates, and modern residential developments across LE postcodes. With one of England's most active property markets, professional asbestos surveys and removal are essential for homeowners, landlords, developers, and the public sector across the city.",
      "Leicester's diverse property market — from Victorian Highfields terraces to 1960s and 70s tower blocks in New Parks and Braunstone — contains asbestos across all construction eras. Our Leicester team provides expert surveys, UKAS-accredited testing, and licensed removal for all property types across Leicestershire postcodes.",
    ],
    facts: [
      {
        label: "Local Property Fact",
        text: "Leicester's Victorian and Edwardian terraces — concentrated across Highfields, Belgrave, Spinney Hills, and Stoneygate — contain high asbestos prevalence, including textured coatings, floor tiles, and pipe lagging added during 20th-century refurbishments.",
      },
      {
        label: "Why Act Now",
        text: "Leicester's ongoing Waterside and Frog Island regeneration, expanding university campus, and city centre apartment programme are generating continuous asbestos disturbance risk across LE postcodes.",
      },
    ],
    calloutText:
      "📊 Leicestershire consistently records high volumes of asbestos removal notifications, driven by the county's large stock of pre-1980 residential and commercial buildings.",
    keywords: [
      "asbestos removal Leicester",
      "asbestos survey Leicester",
      "HSE licensed asbestos Leicester",
      "asbestos testing Leicestershire",
      "asbestos disposal Leicester",
      "garage roof removal Leicester",
    ],
  },
  ...
  whyChooseUs: {
    ...
    title: "Trusted Asbestos Specialists in Leicester",
    subtitle: "Protecting Leicestershire properties and people for over four decades.",
    items: [
      {
        icon: "✓",
      ...
      },
      {
        ...
        text: "Same-day site visits across Leicester. We work to your schedule with minimal disruption.",
      },
    ],
  },
  ...
  process: [
    ...
    },
    {
      ...
      text: "Our surveyor visits your Leicester property and produces a detailed risk assessment.",
    },
    {
      title: "Safe Removal",
  ...
  faqs: [
    {
      question: "How quickly can you respond in Leicester?",
      answer:
        "Our emergency team covers Leicester and all of Leicestershire 24/7. For emergency asbestos incidents we typically have an operative on-site within 2–4 hours. For planned work, we offer same-day or next-day site visits in most cases.",
    },
    {
      question: "Do I need a survey before selling my Leicester property?",
      answer:
        "While not legally required for residential sales, many Leicester buyers and solicitors now request an asbestos survey as part of the conveyancing process, particularly for pre-2000 properties. A management survey provides complete peace of mind for all parties.",
    },
    {
      question: "Can I remove asbestos myself in Leicester?",
      answer:
        "DIY removal of licensed asbestos materials (insulation board, lagging, sprayed coatings) is illegal. Non-licensed materials may technically be removed by the property owner, but this is not recommended. Always use a qualified contractor in Leicester.",
    },
    {
      question: "How long does asbestos removal take in Leicester?",
      answer:
        "This depends on the type and volume of material. A single garage roof removal in Leicester typically takes 2–4 hours. Larger commercial or industrial projects may take several days. We'll provide an accurate programme as part of your quotation.",
    },
    {
  ...
  seoKeywordBlock: {
    title: "Asbestos Services in Leicester — Common Questions & Topics",
    columns: [
      {
        ...
        items: [
          ...
          "Certified asbestos contractors in Leicester",
      ...
      },
      {
        ...
        items: [
          ...
          "How much does asbestos removal cost in Leicester?",
  ...
  areas: [
    {
      ...
      name: "Loughborough",
      blurb:
        "Leicester area — Loughborough is a well-established community in Leicestershire with a mix of Victorian terraces, interwar semis, and post-war developments — all property types known to contain asbestos materials including textured coatings, pipe lagging, and asbestos cement roofing.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      heroImage:
        "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/2ccdd2d37_asbestos-sampling-testing-bury-st-edmunds.webp",
      figureCaption: "HSE Licensed Asbestos Removal — Loughborough, Leicestershire",
      content: [],
    },
    {
      slug: "hinckley",
      name: "Hinckley",
      blurb:
        "Hinckley grew significantly during the 20th century industrial boom. Many residential and commercial properties in Hinckley contain asbestos in roofing, flooring, and pipe insulation, making professional surveys and testing essential before any renovation.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Hinckley, Leicestershire",
      content: [],
    },
    {
      ...
      blurb:
        "Market Harborough has a rich local history dating back centuries, with a property stock ranging from Georgian townhouses to 1970s council estates — all of which may harbour asbestos-containing materials. Our team covers Market Harborough as part of our Leicester network.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Market Harborough, Leicestershire",
      content: [],
    },
    {
      slug: "melton-mowbray",
      name: "Melton Mowbray",
      blurb:
        "Melton Mowbray developed rapidly post-WWII, resulting in a high proportion of properties built with asbestos cement, textured coatings, and pipe lagging. We provide the full range of asbestos services to homeowners, landlords, and businesses in Melton Mowbray.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Melton Mowbray, Leicestershire",
      content: [],
    },
    {
      slug: "coalville",
      name: "Coalville",
      blurb:
        "Coalville is home to a mix of residential and light industrial properties, many constructed or refurbished during the peak asbestos-use era of 1950–2000. Our Leicester-based team provides same-day site visits to Coalville.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Coalville, Leicestershire",
      content: [],
    },
    {
      slug: "oadby",
      name: "Oadby",
      blurb:
        "Oadby features a blend of older stone buildings and 20th-century developments. Pre-2000 properties in Oadby should be surveyed before any renovation work commences — we provide fast, accredited surveys across the area.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Oadby, Leicestershire",
      content: [],
    },
    {
      slug: "wigston",
      name: "Wigston",
      blurb:
        "Wigston expanded substantially throughout the mid-20th century. Asbestos was routinely used in construction during this period, making professional surveys, testing, and removal highly advisable for older properties in Wigston.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Wigston, Leicestershire",
      content: [],
    },
    {
      slug: "blaby",
      name: "Blaby",
      blurb:
        "Blaby has a varied property landscape including commercial premises, schools, and residential homes — many built during the era when asbestos use was widespread in the UK. We serve all property types in Blaby.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Blaby, Leicestershire",
      content: [],
    },
    {
      slug: "lutterworth",
      name: "Lutterworth",
      blurb:
        "Lutterworth contains a number of industrial and warehouse buildings from the post-war era, alongside residential streets that frequently contain asbestos cement roofing and floor tiles. Our licensed team covers Lutterworth 24/7.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Lutterworth, Leicestershire",
      content: [],
    },
    {
      slug: "syston",
      name: "Syston",
      blurb:
        "Syston is a community with older housing stock that often pre-dates the 1999 asbestos ban. Homeowners and landlords in Syston are advised to arrange a management survey — our Leicester team responds within hours.",
      tags: [
        "📋 Surveys",
        "🧪 Testing",
        "🔧 Licensed Removal",
      ...
      figureCaption: "HSE Licensed Asbestos Removal — Syston, Leicestershire",
      content: [],
    },
  ],
