...
// Ported from html/asbestosabatementlincoln.co.uk.html. All copy below
...
const NEARME_IMAGE =
  "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/c78d9a875_asbestos-testing-auckland.webp";
const SURVEY_IMAGE =
...
const CONTRACTORS_IMAGE =
  "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/97967a75f_download3.jpg";
...
const AREA_GAINSBOROUGH_IMAGE = HERO_IMAGE;
const AREA_SLEAFORD_IMAGE =
  "https://media.base44.com/images/public/6a3bc7b45c35bfaca5b859b3/ff9c40246_download1.jpg";
const AREA_NEWARK_IMAGE =
...
const config: SiteConfig = {
  businessName: "Lincoln Asbestos Removal",
  logoLetter: "L",
  city: "Lincoln",
  region: "Lincolnshire",
  country: "GB",
  ...
  hero: {
    tag: "HSE Licensed · Lincolnshire",
    titleBefore: "Lincoln",
    titleHighlight: "Asbestos Removal",
    titleAfter: "Specialists",
    subtitle:
      "Safe, certified, and competitively priced asbestos removal, survey, testing, and disposal services across Lincoln and Lincolnshire. HSE-licensed operatives, UKAS-accredited laboratory analysis, and a commitment to protecting your property and your health.",
    image: HERO_IMAGE,
    trustPills: [
      "✓ HSE Licensed",
      "✓ UKAS Accredited",
  ...
  services: [
    {
      ...
      shortDescription:
        "UKAS-accredited management and R&D surveys across Lincoln and Lincolnshire.",
      heroImage: SURVEY_IMAGE,
      pageSubtitle:
        "UKAS-accredited management and R&D surveys across Lincoln and Lincolnshire. Detailed reports, expert recommendations, fast booking.",
      figureCaption: "Asbestos Surveys — Lincoln, Lincolnshire",
      content: [
        {
          type: "h2",
          text: "Professional Asbestos Surveys in Lincoln, Lincolnshire",
        },
        {
          type: "p",
          text: "An asbestos survey is the critical first step in managing asbestos safely. Under the Control of Asbestos Regulations 2012, all non-domestic properties in Lincoln must have an up-to-date asbestos register. Our UKAS-accredited surveyors provide thorough, compliant surveys for all property types across Lincolnshire.",
        },
        { type: "h2", text: "Types of Asbestos Survey Available in Lincoln" },
        { type: "h3", text: "Management Survey" },
        {
          type: "p",
          text: "The standard survey for occupied premises. Our surveyor systematically inspects and samples suspect materials throughout your Lincoln property, providing a detailed report with risk ratings, photographs, and floor plans. Surveys conducted to HSG264.",
        },
        { type: "h3", text: "Refurbishment & Demolition Survey" },
        {
          type: "p",
          text: "Legally required before any refurbishment or demolition work in Lincoln. A fully intrusive survey identifying all ACMs, including those in inaccessible areas. Required before submitting notifications to the HSE.",
        },
        { type: "h3", text: "Re-Inspection Survey" },
        {
          type: "p",
          text: "Periodic re-inspections of your existing asbestos register ensure it remains accurate and up-to-date for your Lincoln property. Recommended annually or following any disturbance event.",
        },
        { type: "h2", text: "What Your Lincoln Survey Report Includes" },
        {
          type: "ul",
          items: [
        ...
        },
        {
          type: "callout",
          tone: "info",
          text: "📋 Management surveys from £250. R&D surveys priced on application for your Lincoln property.",
        },
        { type: "h2", text: "Duty to Manage Asbestos in Lincoln" },
        {
          type: "p",
          text: "Regulation 4 of the Control of Asbestos Regulations 2012 places a legal duty on anyone responsible for a non-domestic property in Lincoln to manage asbestos. Failure to comply can result in prosecution by the HSE. Our survey service helps you fulfil this duty comprehensively.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "UKAS-accredited asbestos testing, bulk sampling, and air monitoring across Lincoln and Lincolnshire. Fast results, expert analysis from £60.",
      figureCaption: "Asbestos Testing — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Professional Asbestos Testing in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "If you suspect asbestos in your Lincoln property, the only reliable way to confirm its presence and identify fibre types is through laboratory analysis. Our UKAS-accredited asbestos testing service provides fast, accurate results for residential and commercial clients across Lincolnshire.",
        },
        { type: "h2", text: "Asbestos Testing Services in Lincoln" },
        { type: "h3", text: "Bulk Sampling & Analysis" },
        {
          type: "p",
          text: "Our operatives take physical samples of suspect materials from your Lincoln property. Samples are analysed using Polarised Light Microscopy (PLM) in our UKAS-accredited laboratory, identifying the presence and type of asbestos fibres with complete accuracy.",
        },
        { type: "h3", text: "Air Monitoring" },
        {
          type: "p",
          text: "During asbestos removal works in Lincoln, continuous air monitoring ensures fibre concentrations remain below the legal Control Limit of 0.1 f/cm³. Monitoring is conducted by qualified BOHS P402 analysts.",
        },
        { type: "h3", text: "Four-Stage Clearance Testing" },
        {
          type: "p",
          text: "Following licensed asbestos removal, four-stage clearance testing (visual inspection, PCM air testing, reoccupation certificate) confirms your Lincoln property is safe before reoccupation.",
        },
        { type: "h2", text: "When Should You Arrange Asbestos Testing in Lincoln?" },
        {
          type: "ul",
          items: [
            ...
            "You are purchasing a property in Lincoln or Lincolnshire",
    ...
    },
    {
      ...
      pageSubtitle:
        "HSE-licensed asbestos removal contractors serving Lincoln and Lincolnshire. Fully insured, UKAS accredited, and British Standards compliant. Free site visits.",
      figureCaption: "Asbestos Removal Contractors — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "HSE-Licensed Asbestos Contractors in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Selecting the right asbestos removal contractor in Lincoln is one of the most important decisions you can make when dealing with asbestos in your property. Using an unlicensed contractor is illegal for many types of asbestos work, and exposes you and your family or workforce to serious health risks.",
        },
        {
          type: "p",
          text: "Lincoln Asbestos Removal holds a full HSE licence for licensed asbestos removal work. We specialise in asbestos removal, abatement, encapsulation, testing, and clean-up for residential, commercial, and industrial clients across Lincolnshire.",
        },
        { type: "h2", text: "What to Look for in a Lincoln Asbestos Contractor" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Our Experience Across Lincolnshire" },
        {
          type: "p",
          text: "Our team has completed hundreds of asbestos removal projects across Lincoln and Lincolnshire — from Victorian-era residential properties to modern commercial and industrial facilities. We have worked for private homeowners, local authorities, NHS trusts, schools, housing associations, and major developers.",
        },
        { type: "h2", text: "Emergency Contractor Services in Lincoln" },
        {
          type: "p",
          text: "For asbestos emergencies across Lincoln and Lincolnshire, our 24/7 response team can mobilise within hours. We assess the situation, make the area safe, and begin remediation works — all fully documented and compliant.",
        },
      ],
    },
    {
      ...
      content: [
        ...
        { type: "h2", text: "Our Non-Licensed Removal Process in Lincoln" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Non-Licensed Removal Costs in Lincoln" },
        {
          type: "p",
          text: "Non-licensed asbestos removal is significantly more affordable than licensed work. Typical costs in Lincoln range from £300 for small domestic jobs to £2,500+ for larger commercial or industrial projects. All quotations are fixed-price. Contact us for a free site visit and itemised quote.",
        },
        {
          type: "callout",
          tone: "warning",
    ...
    },
    {
      ...
      shortDescription:
        "Specialist removal of asbestos cement garage roofs and full garage dismantle & demolition across Lincolnshire.",
      heroImage: GARAGE_IMAGE,
      pageSubtitle:
        "Safe, professional removal and full dismantle of asbestos cement garage roofs across Lincoln and Lincolnshire. Fast, affordable, fully licensed. Free quotes available.",
      figureCaption: "Garage Roof Removal & Dismantle — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Asbestos Garage Roof Removal & Dismantle in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Asbestos cement corrugated roofing is one of the most common asbestos-containing materials found in Lincoln properties. Many garages, sheds, and outbuildings across Lincolnshire were constructed using asbestos cement sheets before the year 2000. Whether you need the roof sheets removed and replaced, or the entire garage structure dismantled and cleared, our licensed team handles it all as a single, fully managed project.",
        },
        { type: "h2", text: "Signs Your Lincoln Garage Roof Contains Asbestos" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Asbestos Garage Roof Removal in Lincoln" },
        {
          type: "p",
        ...
        { type: "h2", text: "Full Garage Dismantle & Demolition in Lincoln" },
        {
          type: "p",
        ...
        },
        {
          type: "callout",
          tone: "info",
          text: "🏗️ Our combined asbestos removal and garage dismantle package offers significant savings versus using separate contractors. One survey, one team, one fixed price — ask us about our combined packages for Lincoln and Lincolnshire properties.",
        },
        { type: "h2", text: "What Types of Garage We Dismantle in Lincoln" },
        {
          type: "ul",
          items: [
    ...
    },
    {
      ...
      pageSubtitle:
        "Complete re-roofing services for garages, factories, commercial premises, and agricultural buildings following asbestos cement roof removal across Lincoln and Lincolnshire.",
      figureCaption: "Re-Roofing After Asbestos Removal — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Re-Roofing After Asbestos Removal in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Once asbestos cement roofing has been safely removed from your garage, factory, commercial unit, agricultural building, or residential outbuilding in Lincoln, the structure requires a new, weatherproof roof. Rather than leaving you to find a separate roofing contractor, our team provides a complete re-roofing service following all types of asbestos roof removal — available for garages, industrial units, commercial premises, farm buildings, and residential extensions across Lincolnshire.",
        },
        { type: "h2", text: "Re-Roofing Options After Asbestos Removal in Lincoln" },
        { type: "h3", text: "Garage & Domestic Outbuilding Re-Roofing" },
        {
          type: "p",
          text: "After asbestos cement corrugated roofing is removed from garages, car ports, garden rooms, and domestic outbuildings in Lincoln, we offer a range of replacement roofing systems:",
        },
        {
          type: "ul",
          items: [
        ...
        { type: "h3", text: "Commercial & Industrial Re-Roofing in Lincoln" },
        {
          type: "p",
          text: "Industrial units, factory buildings, warehouses, and commercial premises in Lincoln and Lincolnshire often have large areas of asbestos cement roofing requiring replacement. We provide:",
        },
        {
          type: "ul",
          items: [
        ...
        { type: "h3", text: "Agricultural Building Re-Roofing in Lincoln & Lincolnshire" },
        {
          type: "p",
          text: "Farm buildings, storage barns, machinery sheds, and livestock buildings across Lincolnshire frequently have large spans of asbestos cement roofing that require replacement. We work with farmers and rural estate owners to provide:",
        },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Combined Removal & Re-Roofing Package in Lincoln" },
        {
          type: "p",
          text: "Our most popular service for Lincoln and Lincolnshire clients is our combined asbestos removal and re-roofing package. We survey, remove the asbestos roofing, carry out all waste disposal with full documentation, and then install the new roofing system — all in one project, with a single fixed price and a single point of responsibility. This eliminates the risk of programme delays between removal and re-roofing and typically provides significant cost savings versus using two separate contractors.",
        },
        {
          type: "callout",
          tone: "info",
          text: "🏗️ Ask about our combined asbestos roof removal & re-roofing package for your Lincoln property. We'll survey, remove, dispose, and re-roof — all in one visit where possible, with a single fixed-price quotation.",
        },
        { type: "h2", text: "Re-Roofing Costs in Lincoln" },
        {
          type: "p",
          text: "Re-roofing costs after asbestos removal depend on the area, roof pitch, material chosen, and access requirements. Typical costs in Lincoln for a single garage re-roof start from £600. Industrial and agricultural re-roofing is priced per m². Contact us for a free site visit and fixed-price combined quotation.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Complete reboard and plastering services following asbestos artex, ceiling board, and wall board removal across Lincoln and Lincolnshire. Seamless finish guaranteed.",
      figureCaption: "Reboard & Plastering After Asbestos Removal — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Reboard & Plastering After Asbestos Removal in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Removing asbestos artex, asbestos insulation board (AIB) ceilings, or asbestos-containing wall boards leaves the underlying structure exposed. Rather than leaving clients to source a separate contractor, our Lincoln team provides a complete reboard and plastering service following all types of asbestos board and ceiling removal — delivering a seamless, ready-to-decorate finish in one visit.",
        },
        ...
        { type: "h2", text: "Our Reboard & Plastering Service in Lincoln" },
        {
          type: "ul",
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "p",
          text: "For licensed asbestos removal in Lincoln carried out within a full containment enclosure, we carry out systematic leak testing of the enclosure perimeter before removal commences, ensuring no fibres escape to the surrounding environment.",
        },
        { type: "h3", text: "Four-Stage Clearance Testing" },
        {
          type: "p",
          text: "Four-stage clearance is a mandatory process following all licensed asbestos removal in Lincoln. The four stages are:",
        },
        {
          type: "ul",
          items: [
        ...
        {
          type: "p",
          text: "Reassurance air sampling is available for Lincoln properties where asbestos has been disturbed accidentally — for example during renovation works — and where the client needs independent confirmation that the area is safe. Results are typically available within 24–48 hours.",
        },
        {
          type: "callout",
          tone: "info",
          text: "🔬 All air testing in Lincoln is carried out by BOHS P402-qualified analysts. Laboratory analysis is UKAS-accredited to ISO 17025. Results include a full written report and reoccupation certificate where applicable.",
        },
        { type: "h2", text: "Air Testing Costs in Lincoln" },
        {
          type: "p",
          text: "Air testing costs depend on the type of sampling required and the number of samples taken. Four-stage clearance testing for a standard single-room licensed removal in Lincoln typically costs £350–£600. Background sampling and personal air monitoring are priced on application. Contact us for a fixed-price quotation.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Professional soil remediation and contaminated land testing across Lincoln and Lincolnshire. Asbestos in soil, contaminated ground, and brownfield site clearance specialists.",
      figureCaption: "Soil Remediation & Testing — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Soil Remediation & Testing in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Asbestos does not only exist inside buildings — it is commonly found in the ground on brownfield sites, former industrial land, and residential gardens across Lincoln and Lincolnshire. Asbestos-containing materials dumped as hardcore, fly-tipped on land, or left behind from demolished buildings can contaminate soil to significant depths. Our team provides comprehensive soil testing and remediation services for developers, landowners, local authorities, and homeowners across Lincolnshire.",
        },
        { type: "h2", text: "How Does Asbestos Get Into Soil in Lincoln?" },
        {
          type: "ul",
          items: [
            "Demolition hardcore: Crushed asbestos cement used as sub-base or hardcore fill under drives, paths, and floors — extremely common in Lincoln properties built or extended before 2000",
            "Fly-tipping: Illegally dumped asbestos waste on agricultural and brownfield land across Lincolnshire",
            ...
            "Industrial sites: Former factories, yards, and industrial premises in Lincoln where asbestos was routinely stored, processed, or discarded",
          ],
        },
        { type: "h2", text: "Soil Testing for Asbestos in Lincoln" },
        {
          type: "p",
        ...
        },
        {
          ...
          items: [
            ...
            "Trial pit and borehole investigation — physical ground investigation to characterise the depth and extent of contamination across the Lincoln site",
            ...
            "Contamination report — a formal site investigation report presenting findings, risk assessment, and remediation recommendations, suitable for submission to Lincolnshire Council planning teams",
          ],
        },
        { type: "h2", text: "Soil Remediation Services in Lincoln" },
        ...
        { type: "h2", text: "Get a Soil Testing & Remediation Quote for Your Lincoln Site" },
        {
          type: "p",
          text: "Contact our Lincoln team today for a free initial consultation and fixed-price quotation for soil investigation and remediation across Lincolnshire.",
        },
      ],
    },
    {
      ...
      shortDescription:
        "Pre-demolition surveys, soft strip, structural demolition, and site clearance across Lincolnshire.",
      heroImage: DEMOLITION_IMAGE,
      pageSubtitle:
        "Safe, licensed demolition services across Lincoln and Lincolnshire. Pre-demolition asbestos surveys, structural demolition, soft strip, and site clearance. HSE notified, fully insured.",
      figureCaption: "Demolition Services — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Demolition Services in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Our Lincoln team provides professional demolition services for residential, commercial, and industrial structures across Lincolnshire — from single garage demolition and internal soft strip to full structural demolition of large commercial and industrial buildings. Crucially, all demolition work is preceded by a thorough refurbishment and demolition (R&D) asbestos survey and the removal of all identified ACMs before any structural works commence, ensuring full HSE compliance and the safety of all workers and neighbouring occupiers.",
        },
        { type: "h2", text: "Our Demolition Services in Lincoln" },
        { type: "h3", text: "Pre-Demolition Asbestos Survey" },
        {
          type: "p",
          text: "The Control of Asbestos Regulations 2012 requires a refurbishment and demolition (R&D) survey to be completed before any demolition work in Lincoln. This is a fully intrusive survey that identifies all asbestos-containing materials — including those in inaccessible locations — and provides a schedule for their removal before demolition proceeds. Our UKAS-accredited surveyors carry out R&D surveys across all Lincolnshire property types.",
        },
        ...
        {
          type: "p",
          text: "Our Lincoln structural demolition team provides safe, controlled demolition of residential and commercial structures including:",
        },
        {
          type: "ul",
          items: [
        ...
        {
          type: "p",
          text: "Following demolition, our team provides comprehensive site clearance — breaking out foundations, removing all demolition arisings, grading the site to formation level, and leaving the ground ready for your next development phase. Combined demolition and muck-away packages are available across Lincolnshire.",
        },
        {
          type: "callout",
          tone: "info",
          text: "🛡️ All demolition work carried out by our Lincoln team is HSE notified where required, fully insured, and conducted in accordance with BS 6187:2011 Code of Practice for Full and Partial Demolition. Method statements and risk assessments are provided for every project.",
        },
        { type: "h2", text: "Get a Demolition Quote in Lincoln" },
        {
          type: "p",
          text: "Contact our Lincoln team for a free site survey and fixed-price demolition quotation across Lincolnshire. We handle everything from pre-demolition survey to site clearance — one contractor, one price.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Licensed muck away and waste haulage across Lincoln and Lincolnshire. Soil, demolition arisings, asbestos-contaminated material, and construction waste removed and disposed of compliantly.",
      figureCaption: "Muck Away Services — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Muck Away Services in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Our Lincoln muck away service provides fast, cost-effective removal and disposal of soil, demolition arisings, construction waste, and excavated material from sites across Lincolnshire. As a licensed waste carrier with our own haulage fleet, we provide competitive muck away services for developers, building contractors, groundworkers, homeowners, and local authorities across Lincoln and the surrounding area.",
        },
        { type: "h2", text: "What We Remove" },
        {
          type: "ul",
          items: [
            "Clean excavated soil and subsoil — from construction excavations, garden re-levels, and drainage works across Lincolnshire",
            "Demolition arisings — brick, concrete, timber, and mixed demolition waste from structural demolition projects in Lincoln",
        ...
        { type: "h2", text: "Our Muck Away Process in Lincoln" },
        {
          type: "ul",
          items: [
            "Waste classification: Before any material is removed from your Lincoln site, we classify the waste in accordance with the Waste Framework Directive and confirm the appropriate disposal route — essential for both compliance and cost management",
            "Loading and haulage: Our fleet of tipper lorries and grab vehicles provides efficient, rapid loading and haulage from sites across Lincolnshire",
        ...
        { type: "h2", text: "Muck Away Costs in Lincoln" },
        {
          type: "p",
          text: "Muck away costs in Lincoln depend on the type and volume of material, access to the site, and the applicable disposal route. Clean inert soil removal starts from £150 per load. Asbestos-contaminated material is priced on application following site assessment. Contact us for a competitive, fixed-price quotation across Lincolnshire.",
        },
        { type: "h2", text: "Get a Muck Away Quote for Your Lincoln Site" },
        {
          type: "p",
          text: "Call our Lincoln team today for rapid, cost-effective muck away services across Lincolnshire. Same-day and next-day loading available on most projects.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Licensed asbestos waste disposal in Lincoln, Lincolnshire. Full consignment note documentation. Certified, safe, and fully compliant with UK waste regulations.",
      figureCaption: "Asbestos Disposal — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Licensed Asbestos Disposal in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Asbestos waste is classified as hazardous waste under the Hazardous Waste Regulations 2005. In Lincoln and across Lincolnshire, all asbestos waste must be handled, transported, and disposed of in strict accordance with the law. Lincoln Asbestos Removal holds a valid waste carrier's licence and ensures full legal compliance on every project.",
        },
        { type: "h2", text: "Legal Requirements for Asbestos Disposal in Lincoln" },
        {
          type: "ul",
          items: [
        ...
        { type: "h2", text: "Our Lincoln Asbestos Disposal Process" },
        {
          type: "p",
        ...
        { type: "h2", text: "Disposal Costs in Lincoln" },
        {
          type: "p",
          text: "Disposal costs depend on the type and volume of asbestos waste. All disposal costs are included in our removal quotations — there are no surprise charges. Contact us for a specific disposal quote for your Lincoln project.",
        },
      ],
    },
    {
      ...
      pageSubtitle:
        "Transparent pricing for asbestos removal, surveys, testing, and encapsulation across Lincoln and Lincolnshire. No hidden fees.",
      figureCaption: "Asbestos Removal Costs — Lincoln, Lincolnshire",
      content: [
        { type: "h2", text: "Asbestos Removal Costs in Lincoln, Lincolnshire" },
        {
          type: "p",
          text: "Understanding asbestos removal costs in Lincoln is essential to planning your project. At Lincoln Asbestos Removal, we provide fixed-price, fully itemised quotations — no surprises, no hidden charges.",
        },
        {
          type: "priceGrid",
          items: [
        ...
        { type: "h2", text: "What Affects Asbestos Removal Costs in Lincoln?" },
        {
          type: "ul",
          items: [
            ...
            "Location: Properties in central Lincoln versus outlying Lincolnshire areas may have different logistics costs.",
        ...
        { type: "h2", text: "Asbestos Encapsulation Costs in Lincoln" },
        {
          type: "p",
        ...
        { type: "h2", text: "Get an Accurate Quote for Your Lincoln Property" },
        {
          type: "p",
          text: "Contact our team today for a free site visit and fixed-price quotation for your Lincoln or Lincolnshire property.",
        },
      ],
    },
  ],
  ...
  localInfo: {
    tag: "Local Expertise — Lincoln",
    title: "Asbestos in Lincoln's Historic Hilltop and Post-War Properties",
    paragraphs: [
      "Lincoln's stunning hilltop cathedral and castle, surrounding Georgian Bailgate area, and extensive Victorian and post-war residential areas across LN postcodes create a varied asbestos landscape. As Lincolnshire's county city and a growing university centre, professional asbestos surveys and removal are essential for homeowners, developers, and the public sector across the region.",
      "Lincoln's property landscape spans medieval Bailgate townhouses, Victorian terraces, and vast post-war housing estates — each with distinct asbestos profiles. Our Lincoln team provides expert surveys, testing, and licensed removal for all property types across Lincolnshire, with rapid response across both urban and rural areas.",
    ],
    facts: [
      {
        label: "Local Property Fact",
        text: "Lincoln's post-war housing estates — particularly across LN6 Birchwood, North Hykeham, and Skellingthorpe — contain high asbestos prevalence across all house types, including textured coatings, insulation board, and asbestos cement cladding.",
      },
      {
        label: "Why Act Now",
        text: "Lincoln's Waterside South regeneration, expanding university campus, and significant rural development pipeline are generating continuous asbestos disturbance risk across LN postcodes.",
      },
    ],
    calloutText:
      "📊 Lincolnshire consistently records high volumes of asbestos removal notifications, driven by the county's large rural and semi-rural housing stock and active agricultural sector.",
    keywords: [
      "asbestos removal Lincoln",
      "asbestos survey Lincoln",
      "HSE licensed asbestos Lincoln",
      "asbestos testing Lincolnshire",
      "asbestos disposal Lincoln",
      "garage roof removal Lincoln",
    ],
  },
  ...
  whyChooseUs: {
    ...
    title: "Trusted Asbestos Specialists in Lincoln",
    subtitle:
      "Protecting Lincolnshire properties and people for over four decades.",
    items: [
      {
        icon: "✓",
      ...
      },
      {
        ...
        text: "Same-day site visits across Lincoln. We work to your schedule with minimal disruption.",
      },
    ],
  },
  ...
  process: [
    ...
    },
    {
      ...
      text: "Our surveyor visits your Lincoln property and produces a detailed risk assessment.",
    },
    {
      title: "Safe Removal",
  ...
  faqs: [
    {
      question: "How quickly can you respond in Lincoln?",
      answer:
        "Our emergency team covers Lincoln and all of Lincolnshire 24/7. For emergency asbestos incidents we typically have an operative on-site within 2–4 hours. For planned work, we offer same-day or next-day site visits in most cases.",
    },
    {
      question: "Do I need a survey before selling my Lincoln property?",
      answer:
        "While not legally required for residential sales, many Lincoln buyers and solicitors now request an asbestos survey as part of the conveyancing process, particularly for pre-2000 properties. A management survey provides complete peace of mind for all parties.",
    },
    {
      question: "Can I remove asbestos myself in Lincoln?",
      answer:
        "DIY removal of licensed asbestos materials (insulation board, lagging, sprayed coatings) is illegal. Non-licensed materials may technically be removed by the property owner, but this is not recommended. Always use a qualified contractor in Lincoln.",
    },
    {
      question: "How long does asbestos removal take in Lincoln?",
      answer:
        "This depends on the type and volume of material. A single garage roof removal in Lincoln typically takes 2–4 hours. Larger commercial or industrial projects may take several days. We'll provide an accurate programme as part of your quotation.",
    },
    {
  ...
  seoKeywordBlock: {
    title: "Asbestos Services in Lincoln — Common Questions & Topics",
    columns: [
      {
        ...
        items: [
          ...
          "Certified asbestos contractors in Lincoln",
      ...
      },
      {
        ...
        items: [
          ...
          "How much does asbestos removal cost in Lincoln?",
  ...
  areas: [
    {
      ...
      name: "Gainsborough",
      blurb:
        "Lincoln area — Gainsborough is a well-established community in Lincolnshire with a mix of Victorian terraces, interwar semis, and post-war developments — all property types known to contain asbestos materials including textured coatings, pipe lagging, and asbestos cement roofing.",
      tags: AREA_TAGS,
      heroImage: AREA_GAINSBOROUGH_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Gainsborough, Lincolnshire",
      content: [],
    },
    {
      slug: "sleaford",
      name: "Sleaford",
      blurb:
        "Sleaford grew significantly during the 20th century industrial boom. Many residential and commercial properties in Sleaford contain asbestos in roofing, flooring, and pipe insulation, making professional surveys and testing essential before any renovation.",
      tags: AREA_TAGS,
      heroImage: AREA_SLEAFORD_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Sleaford, Lincolnshire",
      content: [],
    },
    {
      ...
      blurb:
        "Newark-on-Trent has a rich local history dating back centuries, with a property stock ranging from Georgian townhouses to 1970s council estates — all of which may harbour asbestos-containing materials. Our team covers Newark-on-Trent as part of our Lincoln network.",
      tags: AREA_TAGS,
      heroImage: AREA_NEWARK_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Newark-on-Trent, Lincolnshire",
      content: [],
    },
    {
      slug: "grantham",
      name: "Grantham",
      blurb:
        "Grantham developed rapidly post-WWII, resulting in a high proportion of properties built with asbestos cement, textured coatings, and pipe lagging. We provide the full range of asbestos services to homeowners, landlords, and businesses in Grantham.",
      tags: AREA_TAGS,
      heroImage: AREA_GRANTHAM_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Grantham, Lincolnshire",
      content: [],
    },
    {
      slug: "boston",
      name: "Boston",
      blurb:
        "Boston is home to a mix of residential and light industrial properties, many constructed or refurbished during the peak asbestos-use era of 1950–2000. Our Lincoln-based team provides same-day site visits to Boston.",
      tags: AREA_TAGS,
      heroImage: AREA_BOSTON_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Boston, Lincolnshire",
      content: [],
    },
    {
      slug: "spalding",
      name: "Spalding",
      blurb:
        "Spalding features a blend of older stone buildings and 20th-century developments. Pre-2000 properties in Spalding should be surveyed before any renovation work commences — we provide fast, accredited surveys across the area.",
      tags: AREA_TAGS,
      heroImage: AREA_SPALDING_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Spalding, Lincolnshire",
      content: [],
    },
    {
      slug: "louth",
      name: "Louth",
      blurb:
        "Louth expanded substantially throughout the mid-20th century. Asbestos was routinely used in construction during this period, making professional surveys, testing, and removal highly advisable for older properties in Louth.",
      tags: AREA_TAGS,
      heroImage: AREA_LOUTH_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Louth, Lincolnshire",
      content: [],
    },
    {
      slug: "grimsby",
      name: "Grimsby",
      blurb:
        "Grimsby has a varied property landscape including commercial premises, schools, and residential homes — many built during the era when asbestos use was widespread in the UK. We serve all property types in Grimsby.",
      tags: AREA_TAGS,
      heroImage: AREA_GRIMSBY_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Grimsby, Lincolnshire",
      content: [],
    },
    {
      slug: "scunthorpe",
      name: "Scunthorpe",
      blurb:
        "Scunthorpe contains a number of industrial and warehouse buildings from the post-war era, alongside residential streets that frequently contain asbestos cement roofing and floor tiles. Our licensed team covers Scunthorpe 24/7.",
      tags: AREA_TAGS,
      heroImage: AREA_SCUNTHORPE_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Scunthorpe, Lincolnshire",
      content: [],
    },
    {
      slug: "stamford",
      name: "Stamford",
      blurb:
        "Stamford is a community with older housing stock that often pre-dates the 1999 asbestos ban. Homeowners and landlords in Stamford are advised to arrange a management survey — our Lincoln team responds within hours.",
      tags: AREA_TAGS,
      heroImage: AREA_STAMFORD_IMAGE,
      figureCaption: "HSE Licensed Asbestos Removal — Stamford, Lincolnshire",
      content: [],
    },
  ],
